...
1. Обробник `finally` не приймає аргументів. В `finally` ми не знаємо як був завершений проміс, успішно чи ні. І це нормально, тому що зазвичай наше завдання полягає в тому, щоб виконати "загальні" процедури доопрацювання.
...
Тепер, розгляньмо декілька прикладів з тим як проміси можуть полегшити нам написання асинхронного коду.
